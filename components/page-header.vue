		...
		<div class="container m-auto">
			...
			<div class="flex-none">
				...
				<div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
					...
					<div class="mx-3 p-1 flex cursor-pointer"
						 @click="handlePin">
...
<style lang="postcss"
	   scoped>
	.page-header {
		@apply sticky top-0 z-20 navbar transition-all duration-100 backdrop-blur glass bg-opacity-70 shadow-md;
	}

	.pin-header {
		@apply container btn-ghost max-w-144 rounded-3xl bg-base-200 bg-opacity-70 m-auto;
