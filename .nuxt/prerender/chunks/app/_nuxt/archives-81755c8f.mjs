...
import { useSSRContext, defineComponent, withAsyncContext, ref, mergeProps, unref } from 'file:///Users/gaowenju/my-job/app-site/node_modules/.pnpm/registry.npmjs.org+vue@3.3.4/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr } from 'file:///Users/gaowenju/my-job/app-site/node_modules/.pnpm/registry.npmjs.org+vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-4 xl:w-10/12 m-auto max-w-screen-xl py-5" }, _attrs))} data-v-ee444989>`);
      _push(ssrRenderComponent(_component_ClientOnly, {
        "fallback-tag": "span",
        fallback: "Loading comments..."
      }, {}, _parent));
      _push(`<!--[-->`);
      ssrRenderList(unref(mapList), (item, index) => {
        _push(`<div class="item" data-v-ee444989><div class="${ssrRenderClass(`collapse rounded-none pl-8  collapse-arrow ${unref(opens).includes(index) ? "collapse-open" : ""}`)}" data-v-ee444989><div class="collapse-title rounded bg-base-200" data-v-ee444989>${ssrInterpolate(index)}</div><div class="collapse-content" data-v-ee444989><!--[-->`);
        ssrRenderList(item, (child) => {
          _push(`<p class="py-2" data-v-ee444989><a class="link link-hover block truncate break-all"${ssrRenderAttr("href", child._path)} data-v-ee444989><span class="i-mdi-link-variant" data-v-ee444989></span> ${ssrInterpolate(child.title)}</a></p>`);
        });
        _push(`<!--]--></div></div></div>`);
      });
      _push(`<!--]--></div>`);
...
const archives = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ee444989"]]);

export { archives as default };
//# sourceMappingURL=archives-81755c8f.mjs.map
