...
import daisyui from "#build/tailwind.config/daisyui.mjs"
...
const config = { theme, corePlugins, plugins, content, darkMode, daisyui, presets, prefix, important, separator, safelist, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, daisyui, presets, prefix, important, separator, safelist, blocklist }